...
dataSet[dataSetVersion].options = [
  {
    ...
    sub: [
      ...
      { name: "Others", tooltip: "Includes Bulins, Collab characters and other lesser represented factions", key: "others" }
    ]
  },/*
  {
...
dataSet[dataSetVersion].characterData = [
  {
    ...
    img: "c5DqpgX.png",
    opts: {
      faction: [ "book", "EoSD", "PCB", "IaMP", "IN", "PoFV", "StB", "SWR", "MoF", "SA", "UFO", "soku", "DS", "TD", "HM", "DDC", "ISC", "ULiL", "LoLK", "AoCF", "HSiFS", "VD", "WBaWC" ],
      stage: ["st4"]
    }
  },
  {
